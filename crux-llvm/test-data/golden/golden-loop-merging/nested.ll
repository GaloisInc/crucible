; ModuleID = 'nested.bc'
source_filename = "test-data/golden/golden-loop-merging/nested.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"b\00", align 1
@.str.1 = private unnamed_addr constant [46 x i8] c"test-data/golden/golden-loop-merging/nested.c\00", align 1
...
18:                                               ; preds = %14
  call void @llvm.dbg.value(metadata i32 %16, metadata !12, metadata !DIExpression()), !dbg !22
  %19 = icmp slt i32 %16, 18, !dbg !42
  %20 = zext i1 %19 to i8, !dbg !43
  tail call void @crucible_assert(i8 zeroext %20, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.1, i64 0, i64 0), i32 19) #3, !dbg !44
  br label %21, !dbg !45
...
!1 = !DIFile(filename: "test-data/golden/golden-loop-merging/nested.c", directory: "/home/abakst/crucible/crux-llvm")
!2 = !{}
