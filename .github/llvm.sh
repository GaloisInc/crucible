...
# https://github.com/opencollab/llvm-jenkins.debian.net/blob/f8b8349a485dec4f879724c6aa76e554c358fb59/llvm.sh.
...
#
# If you update this script (e.g., when updating the crux-llvm CI to use a more
# recent LLVM version), make sure to update the commit hash above. The rest of
# this file's contents are taken directly from upstream:
