...
extBlockInput :: BlockInput ext s blocks ret args
              -> BlockInput ext s (blocks ::> tp) ret args
...
appRegMap_extend = unsafeCoerce --Data.Coerce.coerce 
...
appRegMap_insert k v m = MapF.insert (unsafeCoerce k) v (appRegMap_extend m)
