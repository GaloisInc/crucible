...
bugfindingLoopWithCallbacks appCtx modCtx funCtx cfg cruxOpts llvmOpts halloc callbacks specs =
  do
    let runSim preconds =
          Sim.runSimulatorWithCallbacks appCtx modCtx funCtx halloc preconds cfg cruxOpts llvmOpts callbacks specs
...
bugfindingLoop appCtx modCtx funCtx specs cfg cruxOpts llvmOpts halloc =
  post <$>
    bugfindingLoopWithCallbacks
      appCtx
      modCtx
