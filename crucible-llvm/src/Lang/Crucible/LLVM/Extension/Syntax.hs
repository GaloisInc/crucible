...
instance InstantiateFC CrucibleType (LLVMExtensionExpr arch)
instance (ClosedK CrucibleType (LLVMExtensionExpr arch))
...
-- polymorphism (use default definition)
instance InstantiateFC CrucibleType (LLVMStmt arch)
instance (ClosedK CrucibleType (LLVMStmt width))
